...
- During formatting, treat `teamflow_memory` notes as atomic and retain compatibility
  with legacy `workflow_memory` atomic notes and `workflow_finding` monoliths. Equivalent atomic knowledge is `skip`, stronger evidence

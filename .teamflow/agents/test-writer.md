...
permission:
  edit:
    "*": deny
    ".teamflow/runs/test-patches/**": allow
  bash:
    "*": deny
    "git status*": allow
    "git diff*": allow
    ...
    "rustc --version*": allow
    "shasum *": allow
    "./.teamflow/bin/teamflow test-patch check *": allow
    "./.teamflow/bin/teamflow test-patch verify *": allow
  task: deny
  webfetch: deny
  websearch: deny
  skill:

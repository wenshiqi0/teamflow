...
def main() -> None:
    parser = argparse.ArgumentParser(description="Record or inspect a code-workflow phase")
    ...
    run_dir = Path(".workflow/runs/code") / args.run_id
    ...
    if args.command == "start":
        ...
        if value.get("status") == "RUNNING" and value.get("started_at"):
            ...
            value["stale"] = age > int(os.environ.get("WORKFLOW_PHASE_TIMEOUT_SECONDS", "600"))
